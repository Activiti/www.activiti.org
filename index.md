...
<p class="mt-0 bg-green"><a href="{{ page.latest_news_link }}" class="border-t border-white md:border-0 wrap block py-4 text-center text-white text-lg hover:text-green-light"><strong>Latest News: </strong>{{ page.latest_news }}</a></p>
